<template>
  <q-parallax class="border-top" src="~assets/fundo.png">
    <div class="row reverse items-center q-px-xl q-py-xl ">
      <div class="col-12 col-md-4 text-center ">
        <q-img src="~assets/magalu.png" style="width: 250px; height: 250px;"></q-img>
      </div>
  ...
  <div class="row items-center q-pa-xl border-top orientation-portrait">
    <div class="col">
      <div class="flip-card">
  ...
  <div class=" row items-center q-pa-xl border-top orientation-landscape">
    <div class=" col-12 col-sm-6 col-md-4 col-lg-4 card ">
      <q-img src="~assets/pc-gamer.png">
      </q-img>
    </div>
  ...
  <div class=" row items-center q-pa-xl orientation-landscape ">
    <div class="col-12  col-sm-6 col-md-8 col-lg-8 ">
      <q-card class="my-card text-black card-text-border q-ma-lg">
        <q-card-section>
          <div class="text-h6">Our Changing Planet</div>
    ...
    <div class=" col-12 col-sm-6 col-md-4 col-lg-4 card q-mb-lg ">
      <q-img src="~assets/laptop.png">
      </q-img>
    </div>
  </div>
</template>
...
.card {
  ...
  border: solid 5px $card-border-color;
  border-radius: 50px;
}
